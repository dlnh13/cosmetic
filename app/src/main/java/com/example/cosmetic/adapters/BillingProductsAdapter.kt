...
import com.example.cosmetic.databinding.BillingProductsRvItemBinding
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductsRvItemBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                tvCartProductColor.text = billingProduct.selectedColor?:"".also { imageCartProductColor.setImageDrawable(
